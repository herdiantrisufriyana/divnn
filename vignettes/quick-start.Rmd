...
```
```{r include=FALSE}
tidy_set=readRDS('../env/tidy_set.rds')
```
...
```
```{r include=FALSE}
history=readRDS('../env/history.rds')
load_model_weights_hdf5(ontonet,'../env/ontonet.h5')
```
...
```
```{r include=FALSE}
evaluation=readRDS('../env/evaluation.rds')
```
